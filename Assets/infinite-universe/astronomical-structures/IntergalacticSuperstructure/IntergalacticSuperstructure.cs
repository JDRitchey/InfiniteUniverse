...
public class IntergalacticSuperstructure : MonoBehaviour, ExpandableRegion{
  ...
  public void ExpandRegion() {
    ...
    foreach(var node in nodes) {
      ...
      filamentNodeEntity.UniversalPosition = entity.UniversalPosition + BigVec3.create(node.pos*universe.precision);
    ...
    foreach (var segment in segments) {
      ...
      filamentEntity.UniversalPosition = entity.UniversalPosition + BigVec3.create(center*universe.precision);
